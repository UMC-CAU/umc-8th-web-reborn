...
import { SigninFormData, signinSchema } from "../types/authSchemas";
import { z } from "zod";
// import { ApiResponseWrapper, LoginData } from "../types/api"; // 필요하다면 타입을 import하세요
...
const Login = () => {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // login 함수 호출 (API 응답 전체를 전달)
      // login 함수는 ApiResponseWrapper<LoginData> 타입을 기대합니다.
      login(response);
