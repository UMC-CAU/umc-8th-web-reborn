...
import { RequestLpDetailDto, ResponseLpDetailDto, ResponseLpListDto, ResponsetLikeLpDto, CreateLpDto } from "../types/lp";
...
export const createLp = async (lpData: CreateLpDto): Promise<ResponseLpDetailDto> => {
    try {
        // FormData 생성
