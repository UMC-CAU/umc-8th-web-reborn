...
interface LpModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: { title: string, artist: string, tags: string[], thumbnail: File | null }) => void;
}
...
const LpModal = ({ isOpen, onClose, onSubmit }: LpModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* 모달 */}
      <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto p-6 z-10">
        {/* 모달 닫기 버튼 */}
        <button 
          onClick={handleClose}
        ...
        <h2 className="text-xl font-bold mb-6 text-center">LP 추가</h2>
