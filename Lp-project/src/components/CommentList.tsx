  ...
  return (
    <div className="mt-12">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-xl font-semibold text-white">댓글</h3>
        <button
          onClick={handleSortChange}
          className="px-3 py-1 bg-gray-800 border border-gray-700 rounded-md shadow-sm text-sm font-medium text-white hover:bg-gray-700 flex items-center"
        >
      ...
      <div className="bg-gray-800 rounded-lg shadow-sm p-4 mb-6">
        <textarea
          className="w-full p-3 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent bg-gray-800 text-white placeholder-gray-400 resize-none"
          rows={3}
        ...
        <>
          ...
          {data?.pages.map((page) =>
            page.data.map((comment) => (
              <div
                key={comment.id}
                className="bg-gray-800 rounded-lg shadow-sm p-4 mb-4"
              >
